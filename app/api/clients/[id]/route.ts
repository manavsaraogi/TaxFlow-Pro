...
export async function GET(_req: NextRequest, { params }: Params) {
  ...
  const data = {
    ...
    fatherName: (client as any).fatherName ?? null,
    ...
    email: client.email,
    flatDoorBlockNo: (client as any).flatDoorBlockNo ?? null,
    nameBuildingVillage: (client as any).nameBuildingVillage ?? null,
    roadOrStreet: (client as any).roadOrStreet ?? null,
    localityOrArea: (client as any).localityOrArea ?? null,
...
export async function PUT(request: NextRequest, { params }: Params) {
  ...
  await prisma.client.update({
    ...
    data: {
      ...
      ...(body.flatDoorBlockNo !== undefined ? { flatDoorBlockNo: body.flatDoorBlockNo } : {}),
      ...(body.nameBuildingVillage !== undefined ? { nameBuildingVillage: body.nameBuildingVillage } : {}),
      ...(body.roadOrStreet !== undefined ? { roadOrStreet: body.roadOrStreet } : {}),
      ...(body.localityOrArea !== undefined ? { localityOrArea: body.localityOrArea } : {}),
