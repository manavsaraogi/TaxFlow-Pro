...
export const DEDUCTION_CAPS = {
  ...
  StandardDeduction16ia: 75_000,   // Increased from ₹50,000 in AY 2025-26
  EntertainmentAlw16ii: 5_000,
  ProfessionalTax16iii: 5_000,
  FamilyPensionDeduction57iia: 25_000,
  HPLossSetOff: 200_000,           // Max HP loss set-off against other income
  LTCG112AExempt: 125_000,         // Increased from ₹1,00,000 in AY 2025-26
  Rebate87A_old: 12_500,           // Old regime rebate limit
  Rebate87A_new: 60_000,           // New regime rebate limit AY 2025-26
  Rebate87A_incomeLimit_old: 500_000,
  Rebate87A_incomeLimit_new: 1_200_000,
} as const;
